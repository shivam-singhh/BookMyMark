...
public sealed class ReadingListRepository(BookMyMarkDbContext dbContext) : IReadingListRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await query.OrderByDescending(item => item.AddedAt).ToListAsync(cancellationToken);
    }
    ...
    {
        var item = await GetByIdAsync(id, true, cancellationToken);
